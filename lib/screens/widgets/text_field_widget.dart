...
class _TextFieldWidgetState extends State<TextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        style: TextStyle(
          color: ColorConstant.getBlackColor(),
        ),
        ...
        decoration: InputDecoration(
          ...
          labelStyle:
              TextStyle(color: ColorConstant.getHintText(), fontSize: 16),
          floatingLabelStyle:
              TextStyle(color: ColorConstant.getBlackColor(), fontSize: 16),
          prefixIcon:
          ...
          focusedBorder: OutlineInputBorder(
            borderSide:
                BorderSide(color: ColorConstant.getBlackColor(), width: 1),
            borderRadius: BorderRadius.circular(12),
          ),
          suffixIcon: widget.isPasswordField == true
              ? GestureDetector(
                  ...
                  child: Icon(
                    ...
                    color: _obscureText
                        ? ColorConstant.getBlackColor().withOpacity(0.5)
